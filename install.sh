...
echo -n "
Please, enter the path to your SiteRoot: "
read SITEROOT
...
echo "Copying custom CiviCRM extension com.payzang.payment.pzpayments to $CUSTOMPATH/custom_ext"
cp -r ./custom_ext $CUSTOMPATH
chown -R $USERNAME:$GROUPNAME $CUSTOMPATH/custom_ext/
echo "Copying custom Drupal extension pz_payment.module to $SITEROOT/sites/all/modules/civicrm/drupal/modules/pz_payment"
cp -r ./pz_payment $SITEROOT/sites/all/modules/civicrm/drupal/modules
chown -R $USERNAME:$GROUPNAME $SITEROOT/sites/all/modules/civicrm/drupal/modules/pz_payment

echo -n "Please, enter the database name for the CiviCRM database: "
read DBNAME
echo -n "
Please, enter the user name for the CiviCRM database ($DBNAME): "
read USERNAME
mysql -u $USERNAME -p $DBNAME < db_changes.sql
