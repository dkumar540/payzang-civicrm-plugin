...
<div class="crm-block crm-contribution-main-form-block">
  ...
  {if $form.is_recur}
    <div class="crm-section {$form.is_recur.name}-section">
      <div class="label">&nbsp;</div>
      <div class="content">
        <p><strong>{$form.is_recur.html} &nbsp;{$form.frequency_interval.html} &nbsp; {$form.frequency_unit.html}<span id="recur_installments_num">&nbsp; {ts}for{/ts} &nbsp; {$form.installments.html} &nbsp;{$form.installments.label}</span></strong></p>
